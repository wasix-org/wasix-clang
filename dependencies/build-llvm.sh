...
cp $BUILDFILE_DIR/wasix-sysroot/usr/local/lib/wasm32-wasi/libclang_rt.builtins-wasm32.a $BUILDFILE_DIR/wasix-llvm/lib/clang/21/lib/wasm32-unknown-wasi/libclang_rt.builtins.a
cp $BUILDFILE_DIR/wasix-sysroot/usr/local/lib/wasm32-wasi/libclang_rt.profile-wasm32.a $BUILDFILE_DIR/wasix-llvm/lib/clang/21/lib/wasm32-unknown-wasi/libclang_rt.profile.a
